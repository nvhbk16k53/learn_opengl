...
int main(int argc, char **argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        GLint objectColorLoc = glGetUniformLocation(lightingShader.program_, "objectColor");
        GLint lightColorLoc  = glGetUniformLocation(lightingShader.program_, "lightColor");
        GLint lightPosLoc = glGetUniformLocation(lightingShader.program_, "lightPos");

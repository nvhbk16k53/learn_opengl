...
int main(int argc, char **argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		GLint lightAmbientLoc  = glGetUniformLocation(lightingShader.program_, "light.ambient");
		GLint lightDiffuseLoc  = glGetUniformLocation(lightingShader.program_, "light.diffuse");
		GLint lightSpecularLoc = glGetUniformLocation(lightingShader.program_, "light.specular");
		//GLint lightDirPosLoc   = glGetUniformLocation(lightingShader.program_, "light.direction");
		GLint lightPosLoc      = glGetUniformLocation(lightingShader.program_, "light.position");
		GLint lightSpotDirLoc  = glGetUniformLocation(lightingShader.program_, "light.direction");
		GLint lightSpotCutOffLoc = glGetUniformLocation(lightingShader.program_, "light.cutOff");
		GLint lightSpotOutCutOffLoc = glGetUniformLocation(lightingShader.program_, "light.outerCutOff");
		...
		glUniform1f(glGetUniformLocation(lightingShader.program_, "light.constant"),  1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.program_, "light.linear"),    0.09f);
		glUniform1f(glGetUniformLocation(lightingShader.program_, "light.quadratic"), 0.032f);

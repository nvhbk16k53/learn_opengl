...
int main(int argc, char **argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		GLint matAmbientLoc  = glGetUniformLocation(lightingShader.program_, "material.ambient");
		GLint matDiffuseLoc  = glGetUniformLocation(lightingShader.program_, "material.diffuse");
		GLint matSpecularLoc = glGetUniformLocation(lightingShader.program_, "material.specular");
		...
		GLint lightPositionLoc = glGetUniformLocation(lightingShader.program_, "light.position");
